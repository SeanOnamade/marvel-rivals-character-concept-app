            ...
            >
                ...
                <div className="relative z-20 flex h-full">
                    ...
                    <div className="w-[30%] flex-shrink-0 flex flex-col h-full relative">
                        {/* Upload hero image button - top left (hidden in export) */}
                        {!heroData.portraitImage && (
                            <label className="no-export absolute top-4 left-4 flex items-center gap-2 px-3 py-2 bg-marvel-yellow/90 text-black rounded cursor-pointer hover:bg-marvel-yellow transition-colors text-sm font-bold z-30">
                        ...
                        {/* Change image button - when image exists (hidden in export) */}
                        {heroData.portraitImage && (
                            <label className="no-export absolute top-4 left-4 flex items-center gap-1 px-2 py-1 bg-black/60 text-white rounded cursor-pointer hover:bg-black/80 transition-colors text-xs z-30">
